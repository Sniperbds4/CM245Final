...
public class ObjectManager {
	...
	//Portal minigame
	c.getPA().checkObjectSpawn(-1, 2477, 4940, 0, 10);//Door
	c.getPA().checkObjectSpawn(-1, 2478, 4940, 0, 2);//Door
	c.getPA().checkObjectSpawn(-1, 2480, 4956, 0, 2);//Door
	c.getPA().checkObjectSpawn(-1, 2472, 4972, 0, 2);//Door
	c.getPA().checkObjectSpawn(-1, 2447, 4979, 0, 2);//Door

	c.getPA().checkObjectSpawn(7288, 2471, 4956, 0, 10);//portal
	c.getPA().checkObjectSpawn(7288, 2471, 4972, 0, 10);//portal
	c.getPA().checkObjectSpawn(7288, 2479, 4940, 0, 10);//portal
	//end of minigame
        ...
        c.getPA().checkObjectSpawn(2403, 2962, 3210, 1, 10); //RFD CHEST
        c.getPA().checkObjectSpawn(12356, 2962, 3209, -1, 10); //RFD PORTAL
        c.getPA().checkObjectSpawn(411, 2966, 3203, 0, 10); // Curse Prayers
	c.getPA().checkObjectSpawn(409, 2967, 3208, 2, 10); // Normal praying altar
	c.getPA().checkObjectSpawn(410, 2969, 3205, 0, 10); //lunar altar
	c.getPA().checkObjectSpawn(6552, 2968, 3203, 0, 10); //ancient altar
        c.getPA().checkObjectSpawn(26972, 2969, 3208, 2, 10);//Bank booth
        c.getPA().checkObjectSpawn(26972, 2969, 3346, 2, 10);//Bank booth
        c.getPA().checkObjectSpawn(26972, 2970, 3346, 2, 10);//Bank booth
        c.getPA().checkObjectSpawn(26972, 2966, 3208, 2, 10);//Bank booth
        c.getPA().checkObjectSpawn(4390, 2952, 3891, 0, 10);//Icewarriorfrom
        c.getPA().checkObjectSpawn(4389, 2963, 3204, 0, 10);//Icewarriorto
	...
	//newhome
	c.getPA().checkObjectSpawn(-1, 2530, 3496, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2529, 3499, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2528, 3501, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2532, 3494, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2528, 3490, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2533, 3493, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2535, 3489, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2534, 3491, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2533, 3486, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2528, 3488, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2529, 3486, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2533, 3483, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2529, 3484, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2527, 3486, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2526, 3488, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2528, 3481, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2529, 3479, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2528, 3495, 0, 2);//tree
	c.getPA().checkObjectSpawn(-1, 2528, 3496, 0, 2);//tree
	c.getPA().checkObjectSpawn(-1, 2525, 3495, 0, 2);//tree
	c.getPA().checkObjectSpawn(-1, 2523, 3497, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2521, 3493, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2520, 3493, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2518, 3493, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2520, 3497, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2519, 3497, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2518, 3498, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2521, 3501, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2522, 3502, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2523, 3490, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 2519, 3490, 0, 10);//tree
	//
	//New Dzone
	c.getPA().checkObjectSpawn(-1, 3496, 3570, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 3493, 3574, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 3497, 3576, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 3510, 3574, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 3505, 3571, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 3506, 3576, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 3504, 3577, 0, 10);//tree
	c.getPA().checkObjectSpawn(-1, 3502, 3576, 0, 10);//tree
	c.getPA().checkObjectSpawn(4874, 3503, 3562, 0, 10); //
	c.getPA().checkObjectSpawn(4875, 3503, 3563, 0, 10); //
	c.getPA().checkObjectSpawn(4876, 3503, 3564, 0, 10); //
	c.getPA().checkObjectSpawn(4877, 3503, 3565, 0, 10); //
	c.getPA().checkObjectSpawn(4878, 3503, 3566, 0, 10); //
	c.getPA().checkObjectSpawn(410, 3495, 3570, 0, 10); //
	c.getPA().checkObjectSpawn(409, 3500, 3576, 0, 10); //
	c.getPA().checkObjectSpawn(411, 3498, 3576, 0, 10); //
	c.getPA().checkObjectSpawn(6552, 3495, 3576, 0, 10); //
	c.getPA().checkObjectSpawn(8987, 3505, 3573, 0, 10); //
	c.getPA().checkObjectSpawn(2213, 3505, 3570, 0, 10); //
	//
	c.getPA().checkObjectSpawn(409, 2527, 3502, 0, 10);//tree
	c.getPA().checkObjectSpawn(411, 2529, 3502, 0, 10);//tree
	c.getPA().checkObjectSpawn(410, 2532, 3502, 0, 10);//tree
	c.getPA().checkObjectSpawn(6552, 2524, 3502, 0, 10);//tree
	c.getPA().checkObjectSpawn(4389, 2532, 3494, 0, 10);//tree
	c.getPA().checkObjectSpawn(2403, 2522, 3492, 0, 10);//tree
	c.getPA().checkObjectSpawn(12356, 2523, 3492, 0, 10);//tree
	c.getPA().checkObjectSpawn(26972, 2523, 3499, 0, 10);//tree
	c.getPA().checkObjectSpawn(26972, 2521, 3499, 0, 10);//tree
	c.getPA().checkObjectSpawn(7315, 2525, 3473, 0, 10);//tree
	c.getPA().checkObjectSpawn(13405, 2518, 3492, 0, 10);//tree
	c.getPA().checkObjectSpawn(2996, 2525, 3489, 0, 10);//tree
	//
	c.getPA().checkObjectSpawn(11354, 2521, 3487, 0, 10);//tree
	c.getPA().checkObjectSpawn(4874, 2519, 3375, 0, 10); //
	c.getPA().checkObjectSpawn(4875, 2519, 3376, 0, 10); //
	c.getPA().checkObjectSpawn(4876, 2519, 3377, 0, 10); //
	c.getPA().checkObjectSpawn(4877, 2519, 3378, 0, 10); //
	c.getPA().checkObjectSpawn(4878, 2519, 3379, 0, 10); //
	//
	c.getPA().checkObjectSpawn(13405, 2963, 3350, 0, 10); //
	c.getPA().checkObjectSpawn(12356, 2966, 3351, 0, 10); //
	c.getPA().checkObjectSpawn(2403, 2965, 3351, 0, 10); //
	c.getPA().checkObjectSpawn(2996, 2967, 3347, 0, 10); //
	c.getPA().checkObjectSpawn(6552, 2964, 3330, 0, 10); //
	c.getPA().checkObjectSpawn(410, 2962, 3332, 0, 10); //
	c.getPA().checkObjectSpawn(2644, 2737, 3445, 0, 10); //
	c.getPA().checkObjectSpawn(409, 2973, 3341, 0, 10); //
	c.getPA().checkObjectSpawn(411, 2970, 3341, 0, 10); //
	c.getPA().checkObjectSpawn(7315, 2964, 3343, 0, 10); //
	//
        ...
        //brand new home bank by hack3r and Jasper
        c.getPA().checkObjectSpawn(13405, 2962, 3215, 3, 10);//Portal
	...
	c.getPA().checkObjectSpawn(-1, 2969, 3208, 0, 10);//shelf2
        ...
        c.getPA().checkObjectSpawn(26972, 2605, 3155, 2, 10);//Bank booth
        //corners
	...
	c.getPA().checkObjectSpawn(6553, 3218, 9327, 2, 10);
		...
		//TUTISLAND
                c.getPA().checkObjectSpawn(1277, 3105, 3098, 0, 10);
        	c.getPA().checkObjectSpawn(-1, 3098, 3107, 0, 2);//Door
        	c.getPA().checkObjectSpawn(-1, 3089, 3091, 0, 2);//Door
        	c.getPA().checkObjectSpawn(-1, 3079, 3084, 0, 2);//Door
        	c.getPA().checkObjectSpawn(-1, 3072, 3090, 0, 2);//Door
                c.getPA().checkObjectSpawn(2728, 3075, 3081, 0, 10);//range
                c.getPA().checkObjectSpawn(1277, 3106, 3096, 0, 10);
                c.getPA().checkObjectSpawn(1277, 3105, 3093, 0, 10);
                c.getPA().checkObjectSpawn(1277, 3099, 3095, 0, 10);
                c.getPA().checkObjectSpawn(1277, 3099, 3097, 0, 10);
                //Hack3rbank trees
		...
		c.getPA().checkObjectSpawn(11354, 2961, 3204, 0, 10);//rift
...
c.getPA().checkObjectSpawn(2996, 3090, 3492, 1, 10);//crystal chest.
c.getPA().checkObjectSpawn(2996, 2951, 3215, 1, 10);//crystal chest.
...
//thiev stalls
		c.getPA().checkObjectSpawn(4874, 2963, 3217, 1, 10);
		c.getPA().checkObjectSpawn(4875, 2964, 3217, 1, 10);
		c.getPA().checkObjectSpawn(4876, 2965, 3217, 0, 10);
		c.getPA().checkObjectSpawn(4877, 2966, 3217, 0, 10);
		c.getPA().checkObjectSpawn(4878, 2967, 3217, 0, 10);
		//end of thiev stalls continue of varrock city spawns
		//
	c.getPA().checkObjectSpawn(7273, 3204, 3857, -1, 10); //remvoe portal
	//CUSTOM EDGE OBJECTS
	c.getPA().checkObjectSpawn(7315, 2952, 3217, 1, 10);//funpk teleporter
	...
	c.getPA().checkObjectSpawn(6552, 3095, 3500, 0, 10); //ancient altar
		c.getPA().checkObjectSpawn(4874, 3089, 3483, 1, 10);//thiev staff
		c.getPA().checkObjectSpawn(4875, 3088, 3483, 1, 10);//thiev stall
		c.getPA().checkObjectSpawn(4876, 3087, 3483, 0, 10);//thiev stall
		c.getPA().checkObjectSpawn(4877, 3086, 3483, 0, 10);//thiev stall
		c.getPA().checkObjectSpawn(4878, 3085, 3483, 0, 10);//thiev stall
	//END OF EDGE OBJECTS
//dung remove rope
...
c.getPA().checkObjectSpawn(-1, 3508, 9494, -2, 10); //remvoe portal
	...
	c.getPA().checkObjectSpawn(-1, 3098, 3017, 0, 10); //tut island
	// END OF RUNECRAFT
