...
public class movement {
    ...
    public void moveUp(boolean check){
        if (xCoord == 3 && yCoord == 5 && check){
            changeRoom(0, -1);
            yCoord = 1; //should be required to make the character enter at the bottom of the room
            return;
        }
    ...
    public void moveRight(boolean check){
        if (xCoord == 5 && yCoord == 3 && check){//I think logically they are reversed, Im testing now.
            changeRoom(1, 0);
